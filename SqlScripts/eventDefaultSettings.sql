...
INSERT INTO MEMBERSHIP(ID,NAME,EXP_DAYS,TOTAL_POINTS,SETTINGS,CREATED_DATE,MODIFIED_DATE,POINTS_PER_EVENT) VALUES(5,'DIAMOND',3650,4000,"{showOrgName:true,showOrgDesc:true,contactDetails:true,showHostWebsite:true,showAttendeDetails:true}",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,8);
