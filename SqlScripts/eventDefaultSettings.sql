...
ALTER TABLE USER ADD JOB_TITLE varchar(128) DEFAULT 0;
ALTER TABLE TICKET_REGISTER ADD REGISTRATION_LIMIT bigint(10) NOT NULL DEFAULT 15;
...
ALTER TABLE TICKET ADD COLUMN DELETED char(1) NULL;
UPDATE TICKET SET DELETED = 'N' WHERE DELETED IS NULL;
UPDATE TICKET SET ACTIVE = 'Y' WHERE ACTIVE IS NULL;
ALTER TABLE EVENT ADD COLUMN TIME_ZONE varchar(10) NOT NULL default '+05:30';
COMMIT;
