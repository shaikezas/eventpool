...
('EVENTINFO','[{"name":"Prefix (Mr., Mrs., etc.)","type":"DROPDOWN","group":"Contact","options":"Mr.,Mrs.","isValue":true,"isRequired":true},
{"name":"First Name","type":"TEXT","group":"Contact","isValue":true,"isRequired":false,"createdBy":1},
{"name":"Last Name","type":"TEXT","group":"Contact","isValue":false,"isRequired":false},
