...
INSERT INTO MEMBERSHIP(ID,NAME,EXP_DAYS,NO_OF_EVENTS,SETTINGS,CREATED_DATE,MODIFIED_DATE) VALUES(1,'CLASSIC',3650,1000,"{showOrgName:false,showOrgDesc:false,contactDetails:false,showHostWebsite:false,showAttendeDetails:false}",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO MEMBERSHIP(ID,NAME,EXP_DAYS,NO_OF_EVENTS,SETTINGS,CREATED_DATE,MODIFIED_DATE) VALUES(2,'SILVER',3650,2000,"{showOrgName:false,showOrgDesc:false,contactDetails:false,showHostWebsite:false,showAttendeDetails:true}",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO MEMBERSHIP(ID,NAME,EXP_DAYS,NO_OF_EVENTS,SETTINGS,CREATED_DATE,MODIFIED_DATE) VALUES(3,'GOLD',3650,3000,"{showOrgName:false,showOrgDesc:false,contactDetails:false,showHostWebsite:true,showAttendeDetails:true}",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO MEMBERSHIP(ID,NAME,EXP_DAYS,NO_OF_EVENTS,SETTINGS,CREATED_DATE,MODIFIED_DATE) VALUES(4,'PLATINUM',3650,4000,"{showOrgName:true,showOrgDesc:false,contactDetails:false,showHostWebsite:true,showAttendeDetails:true}",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO MEMBERSHIP(ID,NAME,EXP_DAYS,NO_OF_EVENTS,SETTINGS,CREATED_DATE,MODIFIED_DATE) VALUES(5,'DIAMOND',3650,4000,"{showOrgName:true,showOrgDesc:true,contactDetails:true,showHostWebsite:true,showAttendeDetails:true}",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
