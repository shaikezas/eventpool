...
/**
 * Manages commands execution history based on {@link Command} annotation attributes<br>
 * Commands that are annotated as unique=true are stored in this history.<br>
 * History checks if the same commands (equals) is called again.<br>
 * <br>
 * Each commands class has it's own entries in history - history length can be parameterized via constructor parameter.
 * 
 * 
 */
class GateHistory {
	...
	/**
	 * History model. Each commands class has map of executions (commands instance
	 * and time)
	 */
	 ...
	 * 
	 * @param command
	 * @return true if commands is not a repetition, false if commands is
