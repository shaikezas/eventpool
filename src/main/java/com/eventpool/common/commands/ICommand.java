...
@XmlSeeAlso({TicketOrderedCommand.class,TicketBlockedCommand.class,TicketUnBlockedCommand.class,SaveEventCommand.class,TicketCreatedCommand.class,TicketUpdatedCommand.class})
//@XmlRootElement
